  ...
  return (
    <div className="relative w-full">
      ...
      {showCount ? (
        <p
          className={cn(
            'pointer-events-none absolute right-4 bottom-px left-px z-[var(--z-index-form-floating)] m-0 flex h-8 items-center justify-end rounded-bl-lg bg-gray-600 px-4 body-14 text-gray-200',
